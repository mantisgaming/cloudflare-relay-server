/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eb45dcfc73b19813e7fd0591cbc2da76)
// Runtime types generated with workerd@1.20260317.1 2026-01-31 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LobbyDO" | "CodeGeneratorDO" | "IPRateLimiterDO" | "GlobalRateLimiterDO";
	}
	interface StagingEnv {
		RELAY_D1: D1Database;
		CODE_LENGTH: 4;
		CODE_INCREMENTER: 318211;
		MAXIMUM_LOBBY_CONNECTIONS: 12;
		MAXIMUM_MESSAGE_SIZE: 4;
		BASE_ROUTE: "/relay";
		IP_RATE_LIMITER_SHARDS: 1;
		RATE_LIMITER_GLOBAL_ANY_CAPACITY: 200;
		RATE_LIMITER_GLOBAL_ANY_RATE: 1200;
		RATE_LIMITER_GLOBAL_CREATE_CAPACITY: 100;
		RATE_LIMITER_GLOBAL_CREATE_RATE: 300;
		RATE_LIMITER_GLOBAL_RECONNECT_CAPACITY: 100;
		RATE_LIMITER_GLOBAL_RECONNECT_RATE: 300;
		RATE_LIMITER_GLOBAL_JOIN_CAPACITY: 300;
		RATE_LIMITER_GLOBAL_JOIN_RATE: 600;
		RATE_LIMITER_IP_ANY_CAPACITY: 20;
		RATE_LIMITER_IP_ANY_RATE: 120;
		RATE_LIMITER_IP_CREATE_CAPACITY: 10;
		RATE_LIMITER_IP_CREATE_RATE: 30;
		RATE_LIMITER_IP_RECONNECT_CAPACITY: 10;
		RATE_LIMITER_IP_RECONNECT_RATE: 30;
		RATE_LIMITER_IP_JOIN_CAPACITY: 30;
		RATE_LIMITER_IP_JOIN_RATE: 60;
		RATE_LIMITER_CLIENT_MESSAGE_CAPACITY: 10;
		RATE_LIMITER_CLIENT_MESSAGE_RATE: 30;
		RATE_LIMITER_SERVER_MESSAGE_CAPACITY: 30;
		RATE_LIMITER_SERVER_MESSAGE_RATE: 60;
		RATE_LIMITER_LOBBY_REQUEST_CAPACITY: 20;
		RATE_LIMITER_LOBBY_REQUEST_RATE: 60;
		RATE_LIMITER_LOBBY_JOIN_CAPACITY: 20;
		RATE_LIMITER_LOBBY_JOIN_RATE: 30;
		RATE_LIMITER_LOBBY_CONNECT_CAPACITY: 5;
		RATE_LIMITER_LOBBY_CONNECT_RATE: 12;
		RATE_LIMITER_LOBBY_RECONNECT_CAPACITY: 5;
		RATE_LIMITER_LOBBY_RECONNECT_RATE: 12;
		PING_INTERVAL: 1;
		CLEANUP_INTERVAL: 1;
		WEBSOCKET_TIMEOUT_DURATION: 15;
		WEBSOCKET_IDLE_DURATION: 900;
		HMAC_APPLICATION_SECRET: string;
		LOBBY_DO: DurableObjectNamespace /* LobbyDO */;
		CODE_GENERATOR_DO: DurableObjectNamespace /* CodeGeneratorDO */;
		IP_RATE_LIMITER_DO: DurableObjectNamespace /* IPRateLimiterDO */;
		GLOBAL_RATE_LIMITER_DO: DurableObjectNamespace /* GlobalRateLimiterDO */;
	}
	interface Env {
		RELAY_D1: D1Database;
		CODE_LENGTH: 4;
